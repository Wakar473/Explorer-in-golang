...
func Fetched (){
 ...
 r.GET("/latestBlocks", func(c *gin.Context) {
...
// 		switch route.Number {
// 		case "GET":
// 			orderRouteGrouping.GET(route.ParentHash,route.HandlerFunc)
// 		case "POST":
// 			orderRouteGrouping.POST(route.ParentHash,route.HandlerFunc )
// 		case "OPTIONS":
// 			orderRouteGrouping.OPTIONS(route.ParentHash,route.HandlerFunc )
// 		case "PUT":
// 			orderRouteGrouping.PUT(route.ParentHash,route.HandlerFunc)
// 		case "DELETE":
// 			orderRouteGrouping.DELETE(route.ParentHash,route.HandlerFunc)
// 		default:
// 			orderRouteGrouping.GET(route.ParentHash, func(c *gin.Context) {
// 				c.JSON(200, gin.H{
