...
//storing block details in db through websocket
// package main
...
// 	// Your MySQL insertion logic for transaction details
// 	stmtTransaction, err := db.Prepare(`
// 	INSERT INTO transaction_details (block_hash, block_number, chain_id, from, gas, gas_price, hash, maxFee_PerGas, maxPriorityFee_per_gas, nonce, to_address, transaction_index, value)
// 	VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
// 	`)
// 	if err != nil {
// 		return err
